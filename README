...
This directory contains source files for the No linguistic content
...
-   <http://giellatekno.uit.no/zxxdoc/index.html>
-   <https://giellalt.uit.no/tools/docu-zxx-manual.html>
-   <https://giellalt.uit.no/index.html>

## Requirements

In order to compile and use No linguistic content language morphology
and dictionaries, you need:
...
The No linguistic content language sources can be acquired using [giella
