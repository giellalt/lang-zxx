The No linguistic content morphology and tools
==========================================

[![Maturity](https://github.com/giellalt/lang-zxx/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-zxx/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-zxx/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-zxx/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-zxx/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-zxx/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-zxx?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-zxx/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-zxx?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-zxx?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-zxx?platform=mobile&channel=nightly)
...
and dictionaries. The data and implementation are licenced under __GPL__
licence, also detailed in the
[LICENSE](https://github.com/giellalt/lang-zxx/blob/main/LICENSE). The
...
- [Language specific documentation](https://giellalt.github.io/lang-zxx/)
...
[INSTALL](https://github.com/giellalt/lang-zxx/blob/main/INSTALL)
